...
public class RadioBtnMain5 extends LinearLayout implements View.OnClickListener {
    ...
    public RadioBtnMain5(Context context) {
        this(context, null, 0);
    }

    public RadioBtnMain5(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RadioBtnMain5(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        LayoutInflater.from(context).inflate(R.layout.btn_radio5_main, this);
        init();
    }
